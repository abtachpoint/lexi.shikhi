        ...
        actions: [
          Padding(
            ...
            child: ActionChip(
              ...
              label: Text('${state.coins}', style: const TextStyle(fontWeight: FontWeight.w900)),
              onPressed: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => WalletScreen(appState: state)),
              ),
            ),
          ),
        ],
